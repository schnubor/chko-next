...
export const WorkTile: FC<Props> = ({ children, title, description, className = '', link }) => {
    return (
        <Link href={link} className={className}>
            <div className="group relative rounded-lg bg-stone-300 p-4 transition-all ease-out hover:bg-stone-300/70 hover:shadow-lg dark:bg-neutral-800 dark:hover:bg-neutral-800/70">
                {children}
                <div className="mt-6">
